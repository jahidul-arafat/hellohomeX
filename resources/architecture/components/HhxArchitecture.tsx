...
`.trim());
    ...
    // Minimal metadata for sidebar/tooltip (extend as needed)
    ...
    return (
                ...
                <div className="live-card" aria-label="Live Controls">
                    ...
                    <input
                        ...
                        onChange={(e)=> {
                            ...
                            setZoom(v);
                            document.documentElement.style.setProperty('--focus-scale', String(v));
                        }}
        ...
        .hdr {
          ...
          color: #fff; padding: 20px 30px; text-align: center; z-index: 1000;
